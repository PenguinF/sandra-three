...
namespace Sandra.UI
{
    public static class PgnErrorInfoExtensions
    {
        ...
        public static IEnumerable<KeyValuePair<LocalizedStringKey, string>> DefaultEnglishPgnErrorTranslations => new Dictionary<LocalizedStringKey, string>
        {
            ...
            { GetLocalizedStringKey(PgnErrorCode.OrphanBracketOpen), "found '[' character in the middle of a game" },
            { GetLocalizedStringKey(PgnErrorCode.OrphanTagValue), "found tag value in the middle of a game" },
            { GetLocalizedStringKey(PgnErrorCode.OrphanBracketClose), "found ']' character in the middle of a game" },
