...
namespace Eutherion.Text.Json
{
    ...
    public sealed class JsonUndefinedValueSyntax : JsonValueSyntax, IJsonSymbol
    {
        ...
        public override void Accept(JsonSymbolVisitor visitor) => visitor.VisitUndefinedValueSyntax(this);
        public override TResult Accept<TResult>(JsonSymbolVisitor<TResult> visitor) => visitor.VisitUndefinedValueSyntax(this);
        public override TResult Accept<T, TResult>(JsonSymbolVisitor<T, TResult> visitor, T arg) => visitor.VisitUndefinedValueSyntax(this, arg);
    }
}
