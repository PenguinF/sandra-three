...
namespace Eutherion.Text.Json
{
    ...
    public sealed class JsonIntegerLiteralSyntax : JsonValueSyntax, IJsonSymbol
    {
        ...
        public override void Accept(JsonSymbolVisitor visitor) => visitor.VisitIntegerLiteralSyntax(this);
        public override TResult Accept<TResult>(JsonSymbolVisitor<TResult> visitor) => visitor.VisitIntegerLiteralSyntax(this);
        public override TResult Accept<T, TResult>(JsonSymbolVisitor<T, TResult> visitor, T arg) => visitor.VisitIntegerLiteralSyntax(this, arg);
    }
}
