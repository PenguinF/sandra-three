...
{
    /// <summary>
    /// Occurs on code paths which are supposed to be unreachable, relieving the developer of the burden
    /// of having to write dead code which can never be executed.
    /// </summary>
